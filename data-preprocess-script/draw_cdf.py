...
def plot_cdf(datas, linelabels = None, label = None, y_label = "CDF", name = "ss"):
    ...
    plt.xticks([0.00, 0.25, 0.50, 0.75, 1.00],fontsize=_fontsize)
...
divBigger1 = read_div("divergenceInfo-blog")
divBigger2 = read_div("divergenceInfo-email")
divBiggerOpenImg = read_div("divergenceInfo-openImg")
divBiggerQuickDraw = read_div("divergenceInfo-quickDraw")
   


plot_cdf([divBigger1, divBigger2, divBiggerOpenImg, divBiggerQuickDraw], ['email', 'blog', 'openImg', 'quickDraw'], "Data Divergence across Clients", "CDF", "cDiv.pdf")
