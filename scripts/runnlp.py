...
paramsCmd = ' --ps_ip=10.255.11.92 --model=albert-base-v2 --epochs=20000 --upload_epoch=20  --dump_epoch=2 --learning_rate=0.02 --min_learning_rate=1e-5 --decay_epoch=5 --model_avg=True '
