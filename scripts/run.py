...
rawCmd = '\npython ~/DMFL/learner.py --ps_ip=10.255.11.91 --model=MobileNetV2 --epochs=20000 --upload_epoch=50  --dump_epoch=5000 --learning_rate=0.005 --decay_epoch=500 --model_avg=True --batch_size=256 '
...
# deal with ps
rawCmdPs = '\npython ~/DMFL/param_server.py --ps_ip=10.255.11.91 --model=MobileNetV2 --epochs=20000 --upload_epoch=50  --dump_epoch=5000 --learning_rate=0.005 --decay_epoch=500 --model_avg=True --batch_size=256 --this_rank=0 ' + params
