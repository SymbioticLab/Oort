...
rawCmd = '\npython ~/DMFL/learner.py --ps_ip=10.255.11.92 --model=mobilenet_v2 --epochs=20000 --upload_epoch=50  --dump_epoch=4 --learning_rate=0.04 --decay_epoch=50 --model_avg=True --batch_size=128 '
...
# deal with ps
rawCmdPs = '\npython ~/DMFL/param_server.py --ps_ip=10.255.11.92 --model=mobilenet_v2 --epochs=20000 --upload_epoch=25 --dump_epoch=4 --learning_rate=0.04 --decay_epoch=50 --model_avg=True --batch_size=128 --this_rank=0 ' + params
