...
# deal with ps
rawCmdPs = '\npython ~/DMFL/param_server.py --ps_ip=10.255.11.92 --model=mobilenet_v2 --epochs=20000 --upload_epoch=20 --dump_epoch=100 --learning_rate=0.45 --decay_epoch=25 --model_avg=True --batch_size=32 --this_rank=0 ' + params
