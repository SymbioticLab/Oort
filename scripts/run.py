...
with open('vms', 'r') as fin:
    lines = fin.readlines()
    for line in lines:
        if 'gpu-cn0' in line and 'gpu-cn001' not in line and 'gpu-cn002' not in line and 'gpu-cn005' not in line and 'gpu-cn015' not in line:# and 'gpu-cn005' not in line and 'gpu-cn008' not in line:
