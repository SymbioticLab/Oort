...
rawCmd = '\npython ~/DMFL/learner.py --ps_ip=10.255.11.91 --model=MobileNetV2 --epochs=20000 --upload_epoch=30  --dump_epoch=200 --learning_rate=0.05 --decay_epoch=100 --model_avg=True --total_worker=1000 --resampling_interval=1 --batch_size=64 '
...
# deal with ps
rawCmdPs = '\npython ~/DMFL/param_server.py --ps_ip=10.255.11.91 --model=MobileNetV2 --epochs=20000 --upload_epoch=30  --dump_epoch=200 --learning_rate=0.05 --decay_epoch=100 --model_avg=True --total_worker=1000 --resampling_interval=1 --batch_size=64 --this_rank=0 ' + params
