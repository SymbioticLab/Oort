...
rawCmd = '\nsource activate pytorch3 \npython ~/DMFL/learner.py --ps_ip=10.255.11.91 --model=lenet --epochs=20000 --upload_epoch=30  --dump_epoch=200 --learning_rate=0.1 --decay_epoch=50 --model_avg=True  --batch_size=64 --data_dir=~/cifar10/ --backend=tcp '
...
# deal with ps
rawCmdPs = '\nsource activate pytorch3 \npython ~/DMFL/param_server.py --ps_ip=10.255.11.91 --model=lenet --epochs=20000 --upload_epoch=30  --dump_epoch=200 --learning_rate=0.1 --decay_epoch=50 --model_avg=True  --batch_size=64 --data_dir=~/cifar10/ --backend=tcp --this_rank=0 ' + params
