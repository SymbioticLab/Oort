...
def read_pkl(fname):
    # with open(fname + '_data_distr_10k.pkl', 'rb') as f:
    #     distr = pickle.load(f)
    ...
    #         if i == j:
    #             continue
    #         div.append(distance.jensenshannon(i, j))


    with open(fname + '_data_size_10k.pkl', 'rb') as f:
        size = pickle.load(f)
...
speech_size, speech_div = read_pkl('speech')
print("Loading Stack Overflow")
so_size, so_div = read_pkl('stack')
print("Loading reddit")
reddit_size, reddit_div = read_pkl('reddit')
print("Loading openimg")
openimg_size, openimg_div = read_pkl('openimg')
...
plot_cdf([div], ['Speech'], "Normalized Data Size", "CDF across Clients", "cSample.pdf")